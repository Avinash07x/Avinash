...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="max-w-6.1xl mx-auto px-4 flex justify-between items-center py-3 relative">
        ...
        {/* Mobile Menu */}
        <div
          className={`absolute top-full left-0 w-full bg-gray-900 border-b border-gray-700 shadow-xl md:hidden transition-all duration-300 ${mobileMenuOpen
